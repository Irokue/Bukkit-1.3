...
public enum Material {
    ...
    WRITTEN_BOOK(387, 1),
    EMERALD(388, 64),
    CHAISE(200, Stairs.class), 
    TABLE(201), 
    X(202), 
    COAL_BLOCK(203), 
    REDSTONE_BLOCK(204), 
    GLOWING_REDSTONE_BLOCK(205), 
    GRAPPE_CROPS(206), 
    FOIN(207), 
    FOIN_STAIRS(208),
    ORGE_CROPS(209),
    ...
    BRIQUE_FENCE(212),
    DALLE_LAINE(213),
    DEMI_DALLE_LAINE(214),
    DEMI_DALLE_LAINE_ENVERS(215),
    LEAVES_POMMIER(216),
    PINK_FLOWER(217),
    LOVE_FLOWER(218),
    WHITE_FLOWER(219),
    ...
    public boolean isEdible() {
        return equals(Material.BREAD)
        		...
        		|| equals(Material.VIN)
        		|| equals(Material.CHOPPE_BIERE)
        		|| equals(Material.LIQUIDE_SUSPECT)
        		|| equals(Material.BOL_LAIT)
